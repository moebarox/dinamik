...
<html lang="en">
  <head>
    ...
    <title>Event &middot; Dinamik 9</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div id="innerWrap">
        <div class="jumbotron">
          <img class="img-responsive" data-src="holder.js/1100x400/auto" alt="Event">
        </div>
        <ul class="nav nav-pills nav-justified">
          <li <?php if($event == 'pca') echo "class='active'"; ?>><a href="event.php?event=pca">SEMNAS</a></li>
          <li <?php if($event == 'lcw') echo "class='active'"; ?>><a href="event.php?event=lcw">BBT</a></li>
          <li <?php if($event == 'ldg') echo "class='active'"; ?>><a href="event.php?event=ldg">DINAMIK STAR</a></li>
          <li <?php if($event == 'cspc') echo "class='active'"; ?>><a href="event.php?event=cspc">DONOR DARAH</a></li>
          <li <?php if($event == 'lct') echo "class='active'"; ?>><a href="event.php?event=lct">BAZAAR</a></li>
          <li <?php if($event == 'lct') echo "class='active'"; ?>><a href="event.php?event=lct">PAMERAN KARYA</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <div id="myTabContent" class="tab-content">
          <div class="tab-pane fade active in" id="deskripsi">
            <!-- dibuat dinamis berdasarkan parameter event nya -->
            <p>
          ...
          <div class="tab-pane fade" id="pendaftaran">
            ...
            <?php
              if($event == 'lcw'){
                include 'form-lcw.php';
              }else if($event == 'lct'){
                include 'form-lct.php';
              }else if($event == 'ldg'){
                include 'form-ldg.php';
              }else if($event == 'cspc'){
                include 'form-cspc.php';
              }else{
                include 'form-pca.php';
              }
            ?>
