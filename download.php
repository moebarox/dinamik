...
<html lang="en">
  <head>
    ...
    <title>Download &middot; Dinamik 9</title>
    ...
    <style type="text/css">
      ...
      .widget li.list-group-item .list-group-item {padding: 5px 10px}
              ...
              <li class="list-group-item">
                <div class="row">
                  <div class="col-xs-2 col-md-1">
                    <img class="img-circle" src="data:image/png;base64," data-src="holder.js/80x80/auto" alt="Generic placeholder image">
                  </div>
                  <div class="col-xs-10 col-md-11">
                    ...
                    <a href="#" class="list-group-item">adegan_panas_siswi_sma_upacara_bendera.3gp<span class="badge">new</span></a>
                  </div>
                </div>
              </li>
              <li class="list-group-item">
                <div class="row">
                  ...
                  <div class="col-xs-10 col-md-11">
                    ...
                    <a href="#" class="list-group-item">nikmatnya_ulekan_sambel_bi_ijah.3gp<span class="badge">new</span></a>
                  </div>
                </div>
              </li>
            </ul>
