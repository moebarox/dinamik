...
<html lang="en">
  <head>
    ...
    <title>Tentang &middot; Dinamik 9</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div id="innerWrap">
        <div class="jumbotron">
          <img class="img-responsive" data-src="holder.js/1100x400/auto" alt="tentang">
        </div>
        <ul class="nav nav-pills nav-justified">
          <li><a href="about-desc.php">DESKRIPSI</a></li>
          <li><a href="about-theme.php">TEMA</a></li>
          <li class="active"><a href="about-logo.php">LOGO</a></li>
        </ul>
      </div>
      ...
      <!-- tab tentang -->
      <div id="myTabContent">
        <img class="img-responsive" src="assets/img/tentang-logo.png" alt="tentang">
      </div>
