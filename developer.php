...
<html lang="en">
  <head>
    ...
    <title>Developer &middot; Dinamik 9</title>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img data-src="holder.js/245x200" alt="Dion Ajie">
            <div class="caption">
              <h4><strong>Dion Ajie</strong> - <small>Conceptor</small></h4>
              <p>Bandung, Indonesia <i class="glyphicon glyphicon-map-marker"></i></p>
              <p>
                <a href="http://www.facebook.com/dionajie" target="_blank" class="btn btn-success"><i class="fa fa-facebook"></i></a>
                <a href="http://www.twitter.com/dionajie" target="_blank" class="btn btn-success"><i class="fa fa-twitter"></i></a>
                <a href="http://dionajie.com" target="_blank" class="btn btn-success"><i class="fa fa-globe"></i></a>
                <a href="#" class="btn btn-success"><i class="fa fa-envelope-o"></i></a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img src="assets/img/hendra.jpg" alt="Hendra Arfiansyah">
            <div class="caption">
              <h4><strong>Hendra Arfiansyah</strong> - <small>Designer</small></h4>
              <p>Bandung, Indonesia <i class="glyphicon glyphicon-map-marker"></i></p>
              <p>
                <a href="http://www.facebook.com/moebarox" target="_blank" class="btn btn-success"><i class="fa fa-facebook"></i></a>
                <a href="http://www.twitter.com/moebarox" target="_blank" class="btn btn-success"><i class="fa fa-twitter"></i></a>
                <a href="http://moebarox.deviantart.com" target="_blank" class="btn btn-success"><i class="fa fa-globe"></i></a>
                <a href="mailto:hendra.arfiansyah@student.upi.edu" class="btn btn-success"><i class="fa fa-envelope-o"></i></a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            <img data-src="holder.js/245x200" alt="Dimas Restu">
            <div class="caption">
              <h4><strong>Dimas Restu</strong> - <small>Programmer</small></h4>
              <p>Bandung, Indonesia <i class="glyphicon glyphicon-map-marker"></i></p>
              <p>
                <a href="http://www.facebook.com/lucifiarX" target="_blank" class="btn btn-success"><i class="fa fa-facebook"></i></a>
                <a href="http://www.twitter.com/DimasKid" target="_blank" class="btn btn-success"><i class="fa fa-twitter"></i></a>
                <a href="#" target="_blank" class="btn btn-success"><i class="fa fa-globe"></i></a>
                <a href="mailto:dimas.restu@student.upi.edu" class="btn btn-success"><i class="fa fa-envelope-o"></i></a>
              </p>
            </div>
          </div>
        </div>
