    ...
    <div class="container">
      ...
      <div id="innerWrap">
        ...
        <ul class="nav nav-pills nav-justified">
          <li <?php if($lomba == 'pca') echo "class='active'"; ?>><a href="lomba.php?lomba=pca">PCA</a></li>
          <li <?php if($lomba == 'lcw') echo "class='active'"; ?>><a href="lomba.php?lomba=lcw">LCW</a></li>
          <li <?php if($lomba == 'ldg') echo "class='active'"; ?>><a href="lomba.php?lomba=ldg">LDG</a></li>
          <li <?php if($lomba == 'cspc') echo "class='active'"; ?>><a href="lomba.php?lomba=cspc">CSPC</a></li>
          <li <?php if($lomba == 'lct') echo "class='active'"; ?>><a href="lomba.php?lomba=lct">LCT</a></li>
        </ul>
      </div>
